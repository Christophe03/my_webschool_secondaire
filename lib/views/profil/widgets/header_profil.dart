...
import 'package:my_webschool_secondaire/views/profil/widgets/infos_profil.dart';
...
class HeaderProfil extends StatelessWidget {
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  // Gérer la déconnexion sans Firebase
  ...
  nextScreenPopup(BuildContext context, InfosProfilPopup infosProfilPopup) {}

  void nextScreenCloseOthers(BuildContext context, LoginView loginView) {}
}
